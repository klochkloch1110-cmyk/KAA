            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3 ml-2 pl-2">
                  ...
                  <button onClick={signOut} className="w-10 h-10 rounded-full flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-[#151822] border border-transparent hover:border-border transition-all" title="Выйти">
                    <LogOut className="w-4 h-4" />
                  </button>
                </div>
              </div>
    ...
    <div className="p-6">
      <div className="dashboard-panel p-8 text-center mt-8">
        ...
        <div className="space-y-3 text-left">
          <div className="w-full bg-[#1A1D27] border border-border/50 rounded-xl px-6 py-4 text-sm text-foreground">
