...
interface CreateDriverModalProps {
  onClose: () => void;
  onCreated?: (driver: CreatedDriver) => Promise<void> | void;
}
...
export function CreateDriverModal({ onClose, onCreated }: CreateDriverModalProps) {
  ...
  function validate() {
    ...
    if (!form.email.trim()) e.email = "Укажите email для входа";
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setSubmitError(error instanceof Error ? error.message : "Не удалось создать водителя");
    } finally {
      setSubmitting(false);
    }
  }
                ...
                <Field label="Email" required error={errors.email}>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cls(!!errors.email) + " pl-9"}
                    />
                  </div>
                </Field>
                <Field label="Пароль для входа" required error={errors.password}>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cls(!!errors.password) + " pl-9"}
                    />
                  </div>
                </Field>
              </Section>
